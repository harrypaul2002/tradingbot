...
{
    public class CandlesViewModel : ViewModelBase
    {
        ...
        private bool _candleTabSelected;
        public bool CandleTabSelected
        {
            get
            {
                return _candleTabSelected;
            }
            set
            {
                if (_candleTabSelected != value)
                {
                    _candleTabSelected = value;
                    WatchlistTabChanged();
                    RaisePropertyChanged("CandleTabSelected");
                }
            }
        }
